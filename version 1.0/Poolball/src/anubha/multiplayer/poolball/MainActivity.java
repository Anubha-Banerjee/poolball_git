	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Thread(new Runnable() {
	        public void run() { 
	    		...
	    		long lastTime = 0;
	    		long currentTime = 0;
	    		boolean ballInMyCourt = true;
	    		
	    		try {   
	    			sock = new ServerSocket(8888);
	    			Socket newsock = sock.accept();
	    			
	      			//sock = new Socket("192.168.1.3", 8888);		    
